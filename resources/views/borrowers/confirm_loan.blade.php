        ...
        <div class="container-xl">
            ...
            <div class="row row-cards">
                <div class="col-md-12">
                    ...
                    <div class="card mt-2">
                        <form action="{{ url('/borrower/loan/confirm-submit',encrypt($borrower->loan_id)) }}" method="POST" class="card" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-flex">
                                <button type="submit" class="btn btn-primary ms-auto">Confirmed</button>
                            </div>
                            </div>
                        </form>
                    </div>
