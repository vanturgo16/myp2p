    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                ...
                <div class="col-6">
                    <form action="{{ url('/borrower/regist/store') }}" method="POST" class="card" enctype="multipart/form-data">
                        @csrf
                        <div class="card-header">
                            <h4 class="card-title">Daftar Sebagai Peminjam</h4>
                        </div>
                        <div class="card-body">
                            <div class="row g-5">
                                <div class="col-xl-12">
                                    <div class="row">
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="borrower_name" placeholder="Input nama lengkap" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label required">No. Telepon</label>
                                                <input type="text" name="borrower_phone" class="form-control" data-mask="(00) 0000-0000-0000" data-mask-visible="true" placeholder="(00) 0000-0000-0000" autocomplete="off" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label required">Email (Akan digunakan sebagai username)</label>
                                                <input type="email" class="form-control" name="borrower_email" placeholder="Input email" required>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label required">Password</label>
                                                <div>
                                                    <input type="password" class="form-control" placeholder="Input password" name="borrower_password" 
                                                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" 
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div>
                                                    <label class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="borrower_gender" value="M" required>
                                                        <span class="form-check-label">Pria</span>
                                                    </label>
                                                    <label class="form-check form-check-inline">
                                                        <input class="form-check-input" type="radio" name="borrower_gender" value="F" required>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" data-bs-toggle="autosize" placeholder="Input alamat" name="borrower_address" required></textarea>
                                            </div>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" name="borrower_id_card" required>
                                            </div>
                                            <div class="mb-3">
